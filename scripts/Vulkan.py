...
HYDRO_VULKAN_VERSION = '1.3.216.0'
VULKAN_SDK_EXE_PATH = 'Hydro/vendor/VulkanSDK/VulkanSDK.exe'
...
def CheckVulkanSDK():
    if (VULKAN_SDK is None):
        ...
        InstallVulkanPrompt()
        return False
    elif (HYDRO_VULKAN_VERSION not in VULKAN_SDK):
        print(f"Located Vulkan SDK at {VULKAN_SDK}")
        print(f"You don't have the correct Vulkan SDK version! (Hydro requires {HYDRO_VULKAN_VERSION})")
        InstallVulkanPrompt()
        return False
...
OutputDirectory = "Hydro/vendor/VulkanSDK"
